...
// screenshot https://minecraftgods.com/?p=119
// $Id$
/***** FAB.JS v1.0
...
function AddStreets() {
    ...
    function DrawStreetCell(blockX, blockZ, cellX, cellZ) {
        ...
        // add the street
        FillCellLayer(BlockID.LOG, blockX, blockZ, streetLevel - 1, 1, 1);
        FillCellLayer(BlockID.LOG, blockX, blockZ, streetLevel, 1, 1);

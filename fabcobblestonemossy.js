...
// screenshot https://minecraftgods.com/?p=120
// $Id$
/***** FAB.JS v1.0
...
function DrawParkCell(blockX, blockZ, cellX, cellZ, cellW, cellL) {
    ...
    // cap it off
    FillCellLayer(BlockID.MOSSY_COBBLESTONE, blockX, blockZ, streetLevel, cellW, cellL);

    // add some grass
    FillCellLayer(BlockID.GRASS, blockX, blockZ, streetLevel + 1, cellW, cellL);

    // steps up to access point
    blocks[blockX + 7][streetLevel - 6][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 6][streetLevel - 5][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 5][streetLevel - 4][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;

    // platform for access point
    blocks[blockX + 4][streetLevel - 3][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 3][streetLevel - 3][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 2][streetLevel - 3][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 1][streetLevel - 3][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;

    // backfill the wall behind the ladders
    blocks[blockX + 2][streetLevel - 2][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 1][streetLevel - 2][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 2][streetLevel - 1][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX + 1][streetLevel - 1][blockZ + 1] = BlockID.MOSSY_COBBLESTONE;
    ...
    for (var x = 0; x < cellWidth; x++) {
        ...
        if (x == fenceHole || x == cellWidth - fenceHole - 1) {
            blocks[blockX + x][streetLevel + 2][blockZ] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX + x][streetLevel + 2][blockZ + cellLength - 1] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX + x][streetLevel + 3][blockZ] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX + x][streetLevel + 3][blockZ + cellLength - 1] = BlockID.MOSSY_COBBLESTONE;
            ...
            blocks[blockX + x][streetLevel + 2][blockZ] = BlockID.COBBLESTONE_WALL;
            blocks[blockX + x][streetLevel + 2][blockZ + cellLength - 1] = BlockID.COBBLESTONE_WALL;
        }
    }
    ...
    for (var z = 0; z < cellLength; z++) {
        if (z == fenceHole || z == cellLength - fenceHole - 1) {
            blocks[blockX][streetLevel + 2][blockZ + z] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX + cellWidth - 1][streetLevel + 2][blockZ + z] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX][streetLevel + 3][blockZ + z] = BlockID.MOSSY_COBBLESTONE;
            blocks[blockX + cellWidth - 1][streetLevel + 3][blockZ + z] = BlockID.MOSSY_COBBLESTONE;
            ...
            blocks[blockX][streetLevel + 2][blockZ + z] = BlockID.COBBLESTONE_WALL;
            blocks[blockX + cellWidth - 1][streetLevel + 2][blockZ + z] = BlockID.COBBLESTONE_WALL;
        }
    }
...
function AddCitySquares() {
    ...
    function DrawBuildingCell(blockX, blockZ, cellX, cellZ, cellW, cellL) {
        ...
        if (OneInFourChance()) {
            floorID = BlockID.MOSSY_COBBLESTONE;
        ...
        if (OneInThreeChance()) {
            basementFloorID = BlockID.MOSSY_COBBLESTONE;
            basementStairID = BlockID.COBBLESTONE_STAIRS;
            basementLandingID = BlockID.MOSSY_COBBLESTONE;
        }
        if (OneInTwoChance())
            basementWallID = BlockID.MOSSY_COBBLESTONE;
        ...
        if (roofStyle == 3) {
            ...
            AddWalls(BlockID.COBBLESTONE_WALL, blockX + 1, roofAt + floorHeight, blockZ + 1,
        ...
        function RandomMaterial() {
            switch (rand.nextInt(13)) {
                case 1: return BlockID.MOSSY_COBBLESTONE;
        ...
        function PunchBasementStairs(atX, atZ, basements, morestairs) {
            if (basements > 0) {
                ...
                AddWalls(BlockID.COBBLESTONE_WALL, atX - 1, streetLevel + 2, atZ - 2,
                                        atX + 2, atY + 1, atZ + 2);
        ...
        function PunchStairs(stairID, atX, atZ, floorY, addStairwell, addGuardrail, drawStairs) {
            ...
            for (airX = atX; airX < atX + stairHeight; airX++) {
                ...
                if (addGuardrail) {
                    blocks[airX][floorY + 1][atZ + 2] = BlockID.COBBLESTONE_WALL;
                    blocks[airX][floorY + 1][atZ - 1] = BlockID.COBBLESTONE_WALL;
                }
            }
        ...
        function FinalizeStairs(atX, atZ, floorAt, addGuardrail) {
            if (addGuardrail) {
                ...
                for (var z = 0; z < 4; z++)
                    blocks[atX - 2][floorAt][atZ + z - 2] = BlockID.COBBLESTONE_WALL;
            }
        }
    }
}
...
function AddStreets() {
    ...
    function DrawStreetCell(blockX, blockZ, cellX, cellZ) {
        ...
        // add the street
        FillCellLayer(BlockID.MOSSY_COBBLESTONE, blockX, blockZ, streetLevel - 1, 1, 1);
        FillCellLayer(BlockID.MOSSY_COBBLESTONE, blockX, blockZ, streetLevel, 1, 1);
        ...
        function DrawBevelPart(atX, atZ, boxX, boxZ, northSouth) {
            ...
            var blockID = OneInTwoChance() ? BlockID.MOSSY_COBBLESTONE : BlockID.MOSSY_COBBLESTONE;
            if (northSouth)
        ...
        function DrawSewerPart(atX, atZ, boxX, boxZ) {
            ...
            // first the walls
            var wallID = OneInTwoChance() ? BlockID.MOSSY_COBBLESTONE : BlockID.MOSSY_COBBLESTONE;
...
function DrawStreetlight(blockX, blockY, blockZ, lightN, lightE, lightS, lightW) {
    blocks[blockX][blockY][blockZ] = BlockID.MOSSY_COBBLESTONE;
    blocks[blockX][blockY + 1][blockZ] = BlockID.COBBLESTONE_WALL;
    blocks[blockX][blockY + 2][blockZ] = BlockID.COBBLESTONE_WALL;
    blocks[blockX][blockY + 3][blockZ] = BlockID.COBBLESTONE_WALL;
    blocks[blockX][blockY + 4][blockZ] = BlockID.COBBLESTONE_WALL;
...
function AddFarmAndHousesLot() {
    ...
    for (var at = 0; at < squareBlocks * 3; at++) {
        ...
        if (at < lotBlocks - 2 || at > lotBlocks + 2) {
            blocks[squareBlocks + at][streetLevel + 2][squareBlocks + lotBlocks] = BlockID.COBBLESTONE_WALL;
            blocks[squareBlocks + lotBlocks][streetLevel + 2][squareBlocks + at] = BlockID.COBBLESTONE_WALL;
        }
    }
...
function AddParkingLot() {
    ...
    var floorID = BlockID.COBBLESTONE;
    ...
    var fenceID = BlockID.MOSSY_COBBLESTONE;
    ...
    switch (rand.nextInt(3)) {
        case 0:
            {
                fenceID = BlockID.COBBLESTONE_WALL;
        ...
        case 1:
            {
                fenceID = BlockID.MOSSY_COBBLESTONE;
                verticalID = BlockID.MOSSY_COBBLESTONE;
                lowerWallID = BlockID.MOSSY_COBBLESTONE;
                break;
            }
        default:
            {
    ...
    if (OneInTwoChance() && fenceID != BlockID.COBBLESTONE_WALL)
